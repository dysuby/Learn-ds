...
class sort {
  public:
    void shellsort(vector<int> &ele) {
      int temp = 0, j = 0;
      for (int inc = ele.size() / 2; inc > 0; inc /= 2) 
  ...
  private:
    vector<int> Sedgewick{1, 5, 19, 41, 109, 209, 505, 929,
    ...
    vector<int> Hibbard{1, 3, 7, 15, 31, 63, 127, 255,
